...
const getNestedTypes = async () => {
    const rows = await pool.query('select ifnull(t2.id, t1.id)     as "crime_type_id",\n' +
        ...
        '        t1.id                    as "crime_type_parent1_id",\n' +
        '       t1.label                 as "crime_type_parent1",\n' +
        '       t3.id                    as "crime_type_parent2_id",\n' +
        '       t3.label                 as "crime_type_parent2",\n' +
        '       t4.id                    as "crime_type_parent3_id",\n' +
    ...
    const nestedData = rows[0].reduce((acc, cur) => {
        ...
        if (!category) {
            category = {id: cur.crime_type_id, name: cur.crime_type, children: []};
            acc.push(category);
        }
        ...
        if (cur.crime_type_parent2) {
            ...
            if (existingParent2) {
                ...
                parent2 = {id: cur.crime_type_parent2_id, name: parent2Name, children: []};
                category.children.push(parent2);
            }

            let parent1 = parent2.children.find(item => item.name === parent1Name);
            if (!parent1) {
                parent1 = {id: cur.crime_type_parent1_id, name: parent1Name, children: []};
            ...
            if (cur.crime_type_parent3) {
                ...
                if (!parent3) {
                    parent3 = {id: cur.crime_type_parent3_id, name: parent3Name, children: []};
        ...
        if (!parent2) {
            ...
            if (!parent1) {
                parent1 = {id: cur.crime_type_parent1_id, name: cur.crime_type_parent1, children: []};
