    ...
    return (<div className={"h-[calc(100vh-80px)] p-4 overflow-y-scroll w-1/3"}>
        ...
        <div>
            ...
            <div className={"flex flex-row items-center justify-center space-x-2 py-2"}>
                <button className={"bg-transparent hover:bg-blue-500 w-32 h-10 text-blue-700 font-semibold hover:text-white py-2 px-2 border border-blue-500 hover:border-transparent rounded"} onClick={() => props.setHeatMap(false)}>Body</button>
                <button className={"bg-transparent hover:bg-blue-500 w-32 h-10 text-blue-700 font-semibold hover:text-white py-2 px-2 border border-blue-500 hover:border-transparent rounded"} onClick={() => props.setHeatMap(true)}>Heatmapa</button>
            </div>
        </div>
